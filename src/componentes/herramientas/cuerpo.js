...
export default function UnstyledTabsCustomized(props) {
  ...
  return (
    <Container  disableGutters  maxWidth="xl">
      <Grid container spacing={props.orientacion==="vertical" ? 1 :0}  >
        <Grid item xs={props.orientacion==="vertical" ? 2: 12}>
          <Box sx={{width: '100%'}}>
              <Tabs
                value={value}
                onChange={handleChange}
                variant="scrollable"
                orientation={props.orientacion ? props.orientacion : "horizontal"}
                scrollButtons="auto"
                sx={{
                  ...
                  borderRadius: '8px',
                  width: '100%',
                  height: props.orientacion==="vertical" ? window.innerHeight * 0.89 : 'auto', 
        ...
        <Grid item xs={props.orientacion==="vertical" ? 10 : 12}>
          {Bloques
            ?
                Object.keys(Bloques).map((valor,i)=>
                  value===i  && (
