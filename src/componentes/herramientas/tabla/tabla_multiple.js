...
import Esperar from '../../cargar/cargar';
...
function Tabla_multiple (props) {
    ...
    const {Form_origen,Table,Titulo_dialogo,Titulo_tabla,Titulos_tabla, Agregar_mas, //Columnas, 
            ...
            Actualizar_valores, Tam_dialogo, AgregarAccion, PEliminar
          }=props
    ...
    const Abrir = async(valores) =>{
        ...
        const peliminar= PEliminar!==undefined ? PEliminar : true;//await Permiso('eliminar')
        const formulario ={
            ...nuevos,
            // datos:valores,
